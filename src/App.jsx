          ...
          <div className="flex text-white h-12">
            ...
            <div className="flex-1 bg-gray-750 flex items-center justify-between border-b border-gray-900 px-4">
              <div className="flex items-center">
                ...
                <div className="border-l pl-3 ml-3 border-gray-600 text-xs text-gray-400">general discussion of Tailwind CSS</div>
              </div>
              <div className="flex items-center">
                <a href="https://google.com" className="ml-4">
                  <svg className="w-6 h-6 text-gray-500 hover:text-gray-200" fill="currentColor" width={24} height={24} viewBox="0 0 24 24"><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" /></svg>
                </a>
                <a href="https://google.com" className="ml-4">
                  <svg className="w-6 h-6 text-gray-500 hover:text-gray-200" fill="currentColor" viewBox="0 0 24 24">
                    <path className="secondary" d="M2.24 20.35l6.5-7.5a1 1 0 0 1 1.47-.06l1 1a1 1 0 0 1-.06 1.47l-7.5 6.5c-.93.8-2.22-.48-1.4-1.41z" />
                    <path className="primary" d="M15 15.41V18a1 1 0 0 1-.3.7l-1 1a1 1 0 0 1-1.4 0l-8-8a1 1 0 0 1 0-1.4l1-1A1 1 0 0 1 6 9h2.59L13 4.59V3a1 1 0 0 1 1.7-.7l7 7A1 1 0 0 1 21 11h-1.59L15 15.41z" />
                  </svg>
                </a>
                <a href="https://google.com" className="ml-4">
                  <svg className="w-6 h-6 text-gray-500 hover:text-gray-200" fill="currentColor" width={24} height={24} viewBox="0 0 24 24">
                ...
                <a href="https://google.com" className="ml-4">
                  <form action="#" className="relative">
                    ...
                    <span className="absolute right-0 top-0 mr-1" style={{ top: '6px' }}>
                      <svg className="w-4 h-4 text-gray-500 hover:text-gray-200" fill="currentColor" viewBox="0 0 24 24" width={24} height={24}><path className="heroicon-ui" d="M16.32 14.9l5.39 5.4a1 1 0 0 1-1.42 1.4l-5.38-5.38a8 8 0 1 1 1.41-1.41zM10 16a6 6 0 1 0 0-12 6 6 0 0 0 0 12z" /></svg>
                    </span>
                  </form>
                </a>
                <a href="https://google.com" className="ml-4">
                  <svg className="w-6 h-6 text-gray-500 hover:text-gray-200" fill="currentColor" viewBox="0 0 24 24" width={24} height={24}><path className="heroicon-ui" d="M15.6 15.47A4.99 4.99 0 0 1 7 12a5 5 0 0 1 10 0v1.5a1.5 1.5 0 1 0 3 0V12a8 8 0 1 0-4.94 7.4 1 1 0 1 1 .77 1.84A10 10 0 1 1 22 12v1.5a3.5 3.5 0 0 1-6.4 1.97zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" /></svg>
                </a>
                <a href="https://google.com" className="ml-4">
                  <svg className="w-6 h-6 text-gray-500 hover:text-gray-200" fill="currentColor" viewBox="0 0 24 24">
                    <g data-name="Layer 2">
            ...
            <div className="flex-1 flex justify-between">
              <div className="bg-gray-750 flex-1 flex flex-col justify-between">
                <div className="chat text-sm text-gray-400 overflow-y-auto">
                  ...
                  <div className="flex mx-6 my-3 py-4 border-t border-gray-700">
                    ...
                    <div className="ml-5">
                      ...
                      <div>
                        <div>
                          Here are the
                          <a href="https://google.com" className="text-blue-400 hover:underline">Tailwind docs</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex mx-6 my-3 py-4 border-t border-gray-700">
                    ...
                    <div className="ml-5">
                      ...
                      <div>
                        <div>This is handy if you do not want to load SVG as a separate file.</div>
                      </div>
                    </div>
                  </div>
                  <div className="flex mx-6 my-3 py-4 border-t border-gray-700">
                    ...
                    <div className="ml-5">
                      ...
                      <div>
                        <div>
                          ...
                          <a href="https://google.com" className="text-indigo-400 hover:underline">@impulse</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="flex mx-6 my-3 py-4 border-t border-gray-700">
                    ...
                    <div className="ml-5">
                      ...
                      <div>
                        <div>
                          I think it can slow down the page if there is too much bloat in the doc.
                        </div>
                  ...
                  <div className="flex mx-6 my-3 py-4 border-t border-gray-700">
                    ...
                    <div className="ml-5">
                      ...
                      <div>
                        <div>
                          Comparison would be better if it is not also comparing an
                          vector svg to a raster gif, it is a difference in rendering too.
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="ml-5">
                      ...
                      <div>
                        <div>
                          ...
                          Turns out my z-index (or lack of setting one)
                ...
                <div className="bg-gray-750 h-24 flex items-center mx-3 border-t border-gray-600">
                  <button className="px-2 py-2 h-10 bg-gray-700 rounded-l text-gray-500 hover:text-white border-r border-gray-600" type="button">
                  ...
                  <div className="flex-1">
                    <input type="text" className="w-full text-sm h-10 px-2 py-2 bg-gray-700 text-gray-200 focus:outline-none" />
                  </div>
                  <div className="px-2 py-2 bg-gray-700 rounded-r flex items-center h-10">
                    <button className="h-10 bg-gray-700 rounded-l text-gray-500 hover:text-white" type="button">
                    ...
                    <button className="h-10 bg-gray-700 rounded-l text-gray-500 hover:text-white ml-3" type="button">
                      <svg className="w-8 h-8" fill="currentColor" width={24} height={24} viewBox="0 0 24 24">
                        <defs><path id="a" d="M24 24H0V0h24v24z" /></defs>
                        <clipPath id="b"><use xlinkHref="#a" overflow="visible" /></clipPath>
                        <path d="M11.5 9H13v6h-1.5zM9 9H6c-.6 0-1 .5-1 1v4c0 .5.4 1 1 1h3c.6 0 1-.5 1-1v-2H8.5v1.5h-2v-3H10V10c0-.5-.4-1-1-1zm10 1.5V9h-4.5v6H16v-2h2v-1.5h-2v-1z" clipPath="url(#b)" />
                      </svg>
                    </button>
                    <button className="h-10 bg-gray-700 rounded-l text-gray-500 hover:text-white ml-3" type="button">
